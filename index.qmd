...
## References
Best practice guidance for linear mixed-effects models in psychological science [@meteyard2020best].  

An Introduction to Linear Mixed-Effects Modeling in R [@brown2021introduction].

Using linear mixed-effects modeling to evaluate the impact of edaphic factors on spatial variation in winter wheat grain yield [@zhou2022using].

Comparing Linear Mixed Models for Preliminary Yield Trials That Follow Augmented Experimental Designs [@adhikari2016comparing].